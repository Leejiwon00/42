...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/14 19:31:34 by gichlee           #+#    #+#             */
/*   Updated: 2023/08/14 20:20:25 by jiwonle2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	remove_quotes(t_token *tokens);
int		syntax_analyzer(t_cmd **cmds, t_token **t, t_env **env, t_info *info);
int		print_error(t_token *token, char *msg);
int		create_argv(t_cmd *cmd, t_token **tokens);
int		handle_redirection(t_token **tokens, t_cmd *cmds);
...
int		value_substr_to_env_value(t_token *token, int i, t_env *env, int len);
